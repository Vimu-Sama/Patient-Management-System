...
public final class BillingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<billing.BillingRequest,
      billing.BillingResponse> getCreateBillMethod;
  ...
  public static io.grpc.MethodDescriptor<billing.BillingRequest,
      billing.BillingResponse> getCreateBillMethod() {
    io.grpc.MethodDescriptor<billing.BillingRequest, billing.BillingResponse> getCreateBillMethod;
    if ((getCreateBillMethod = BillingServiceGrpc.getCreateBillMethod) == null) {
      synchronized (BillingServiceGrpc.class) {
        if ((getCreateBillMethod = BillingServiceGrpc.getCreateBillMethod) == null) {
          BillingServiceGrpc.getCreateBillMethod = getCreateBillMethod =
              ...
              .setSchemaDescriptor(new BillingServiceMethodDescriptorSupplier("CreateBill"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createBill(billing.BillingRequest request,
  ...
  public static final class BillingServiceStub
    ...
    /**
     */
    public void createBill(billing.BillingRequest request,
        io.grpc.stub.StreamObserver<billing.BillingResponse> responseObserver) {
  ...
  public static final class BillingServiceBlockingStub
    ...
    /**
     */
    public billing.BillingResponse createBill(billing.BillingRequest request) {
  ...
  public static final class BillingServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<billing.BillingResponse> createBill(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BILL:
          serviceImpl.createBill((billing.BillingRequest) request,
              (io.grpc.stub.StreamObserver<billing.BillingResponse>) responseObserver);
          break;
        default:
